...
void gumball_spiraling_randoms() {
  ...
  static const uint8_t DROP_PERCENT_CHANCE = 2; //originally 2
  static const uint8_t SPHERE_FADE = 230; //lower means shorter drops 230 is original for both
  static const uint8_t SPIRAL_FADE = 230;
